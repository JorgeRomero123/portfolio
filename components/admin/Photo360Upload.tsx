...
export default function Photo360Upload() {
  ...
  const uploadSingleFile = async (fileData: FileWithMetadata): Promise<UploadedPhoto> => {
    ...
    const urlResponse = await fetch('/api/photos360/upload-url', {
      method: 'POST',
    ...
    const processResponse = await fetch('/api/photos360/process-upload', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        key,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Upload 360° Photos</h2>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., Travel, Events, Architecture"
            />
              ...
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                {files.length > 0 ? (
                  ...
                  <>
                    ...
                    <p className="text-xs text-gray-500">Multiple 360° photos (PNG, JPG, HEIC)</p>
                  </>
                )}
              </div>
              <input
