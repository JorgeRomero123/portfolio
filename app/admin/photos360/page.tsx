...
import Photo360Upload from '@/components/admin/Photo360Upload';
import { promises as fs } from 'fs';
import path from 'path';
import type { Photo360Data } from '@/lib/types';

export const metadata = {
  title: '360° Photo Management | Admin',
  description: 'Upload and manage 360° photos',
};
...
export default async function Photos360AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">360° Photo Management</h1>
          <p className="text-gray-600">Upload, process, and manage your panoramic photos</p>
        </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">
            Current 360° Photos ({data.photos.length})
          </h2>
